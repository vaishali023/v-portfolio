export const About = () => {
  return (
    <section id="about" className="min-h-100 py-20 px-6 bg-stone-950 text-white font-sans">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="mt-6 text-lg text-gray-300 leading-relaxed">
          My process blends visual design with a deep understanding of usability, layout, accessibility, and interaction. From wireframes to polished UIs, I bring ideas to life through thoughtful design systems and smooth handoff to development.
        </p>
